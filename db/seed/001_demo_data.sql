...
-- =====================================================================
--  NEXT
--    1. python ml/app.py                       (start the ML service)
--    2. python ml/ingest.py --place-cards --origin synthetic
--    3. python ml/ingest.py --path ./data/documents --origin synthetic
--    4. python ml/train_rf.py --semester 2025-2026-1 \
