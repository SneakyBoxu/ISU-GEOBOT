...
start "GeoBot - ML Service (5001)" cmd /k "cd /d %~dp0ml && python app.py"

echo [2/3] Starting Express Backend Server (port 4000)...
start "GeoBot - Backend Server (4000)" cmd /k "cd /d %~dp0server && npm run dev"

echo [3/3] Starting Vite Web Frontend (port 5173)...
start "GeoBot - Web Frontend (5173)" cmd /k "cd /d %~dp0web && npm run dev"
