 ...
 *
 * Mirrors database/sample-data/001_sample_campus_records.sql so that switching from demo mode to a real
...
// Mirrors the `update` block in database/migrations/004_map_pin_icons.sql. Locations not
