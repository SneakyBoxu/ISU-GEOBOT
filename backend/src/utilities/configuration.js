...
// v1.4.0 — real-time date boundary guidance and pronoun neutrality added.
...
// v1.4.0. Changing the prompt without changing this number is how a thesis
// ends up reporting two different systems as one.
export const PROMPT_TEMPLATE_VERSION = 'v1.4.0';
